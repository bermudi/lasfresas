...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="text-[#2A2A2A] hover:text-[#FF4D6D] transition-colors duration-200 font-poppins"
    >
      {children}
    </Link>
  );
...
function MobileNavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="block px-3 py-2 text-base font-medium text-[#2A2A2A] hover:text-[#FF4D6D] transition-colors duration-200"
    >
      {children}
    </Link>
  );
